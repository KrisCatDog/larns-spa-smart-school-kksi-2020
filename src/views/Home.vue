      ...
      >
        ...
        <div class="flex flex-col items-center sm:flex-row mt-6 md:mt-16 -ml-3">
          ...
          >
            ...
            <span class="ml-2 text-sm md:text-base">Sign in</span>
          </router-link>

          <router-link
            :to="{ name: 'Signup' }"
            class="inline-flex items-center bg-transparent hover:bg-red-500 hover:text-white mt-3 sm:mt-0 mx-3 py-2 px-8 transition duration-100 ease-in border border-gray-700 hover:border-red-500 rounded-full"
          >
            <svg
              class="fill-current w-4"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="ml-2 text-sm md:text-base">Sign up</span>
          </router-link>
        </div>
      </div>
